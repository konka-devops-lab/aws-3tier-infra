...
resource "aws_security_group_rule" "bastion_ssh_backend" {
  description              = "This rule allows ssh from 22 from bastion"
  type                     = "ingress"
  from_port                = 22
  to_port                  = 22
  protocol                 = "tcp"
...
resource "aws_security_group_rule" "vpn_ssh_backend" {
  description              = "This rule allows ssh from 22 from vpn"
  type                     = "ingress"
  from_port                = 22
  to_port                  = 22
  protocol                 = "tcp"
...
resource "aws_security_group_rule" "bastion_ssh_frontend" {
  description              = "This rule allows all traffic from 22 from bastion"
  type                     = "ingress"
  from_port                = 22
  to_port                  = 22
  protocol                 = "tcp"
...
resource "aws_security_group_rule" "vpn_ssh_frontend" {
  description              = "This rule allows all traffic from 22 from anywhere"
  type                     = "ingress"
  from_port                = 22
  to_port                  = 22
  protocol                 = "tcp"
